...
export const SchoolSettings = ({ school }: { school: School }) => {
 ...
 <div>
 <h3 className="text-lg font-medium text-slate-900">School Settings</h3>
 <p className="text-sm text-slate-900 font-medium mt-1">Update your school's basic information and logo</p>
 </div>
 </div>
 ...
 <form onSubmit={ handleUpdate } className="space-y-5 bg-white p-4 rounded-2xl border border-slate-300 shadow-sm relative overflow-hidden">
 ...
 <div className="w-20 h-20 rounded-2xl bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center text-slate-900">
 ...
 className="flex-1 px-4 py-3 rounded-xl border border-gray-200/50 bg-white focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all file:mr-4 file:py-2.5 file:px-5 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer"
 />
 </div>
 </div>
 <div className="col-span-1 md:col-span-2">

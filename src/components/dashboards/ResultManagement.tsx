...
import { db, collection, getDocs, query, where, addDoc, updateDoc, setDoc, doc, onSnapshot, serverTimestamp, OperationType, handleFirestoreError } from '../../lib/compatibility';

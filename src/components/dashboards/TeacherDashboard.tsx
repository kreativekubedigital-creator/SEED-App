        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-16">
          <div className="flex items-center gap-6">
            <Link to="/profile" className="relative group cursor-pointer">
              <div className="w-20 h-20 rounded-[2rem] bg-slate-950 flex items-center justify-center text-3xl font-bold text-white shadow-2xl border-4 border-white group-hover:scale-105 transition-all">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <motion.div 
                  ...
                  className="bg-white/90 backdrop-blur-md p-4 rounded-3xl border border-white cursor-pointer shadow-lg shadow-slate-950/5 hover:shadow-slate-950/10 transition-all group overflow-hidden relative"
                >
                  <div className={`absolute -right-2 -top-2 w-12 h-12 bg-slate-950/10 rounded-full blur-xl group-hover:bg-slate-950/20 transition-all`} />
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <motion.button 
                      ...
                      className="p-4 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-slate-950 hover:shadow-xl hover:shadow-slate-950/5 transition-all text-left flex flex-col gap-2 group"
                    >
                ...
                <div className="space-y-3">
                  {assignments.slice(0, 4).map(a => (
                    <motion.div 
                      ...
                      key={a.id} 
                      className="flex gap-4 items-center p-5 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-slate-950 hover:shadow-xl hover:shadow-slate-950/5 transition-all cursor-pointer group"
                    >
                      <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-slate-950 shrink-0 border border-slate-100 shadow-sm group-hover:bg-slate-50 transition-colors">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {subjects.map(subject => (
                <motion.div 
                  ...
                  className="bg-white p-4 rounded-3xl shadow-xl shadow-slate-900/5 border border-white hover:border-slate-200 hover:shadow-slate-950/10 transition-all relative overflow-hidden group"
                >
                  ...
                  <div className="flex items-center gap-3 mb-4 relative z-10">
                    <div className="w-10 h-10 bg-slate-50 text-slate-950 rounded-xl flex items-center justify-center shrink-0 shadow-sm border border-slate-100 group-hover:bg-slate-950 group-hover:text-white transition-all">
                  ...
                  {students.filter(s => s.classId === selectedClassForStudents).map(s => (
                    <div key={s.uid} className="flex items-center gap-6 p-6 rounded-[2rem] bg-slate-50/50 border border-slate-100 hover:bg-white hover:shadow-2xl transition-all group">
                      {s.photoUrl ? (
                        ...
                        <div className="w-16 h-16 rounded-2xl bg-slate-950 flex items-center justify-center font-bold text-white text-xl shadow-lg border-2 border-white group-hover:scale-105 transition-transform">

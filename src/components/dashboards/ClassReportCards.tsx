...
export const ClassReportCards: React.FC<ClassReportCardsProps> = ({ school }) => {
 ...
 <label className="text-[10px] font-medium uppercase tracking-widest text-slate-900 ml-1">Session</label>
 <select
 ...
 <div className="space-y-1.5">
 <label className="text-[10px] font-medium uppercase tracking-widest text-slate-900 ml-1">Term</label>
 <select
 value={ selectedTerm }
 ...
 <div className="space-y-1.5">
 <label className="text-[10px] font-medium uppercase tracking-widest text-slate-900 ml-1">Class</label>
 <select
 value={ selectedClass }

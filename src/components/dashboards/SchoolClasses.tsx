...
export const SchoolClasses = ({ school }: { school: School }) => {
 ...
 <h3 className="text-lg font-medium text-slate-900">Classes & Subjects</h3>
 ...
 <button onClick={() => setClassToDelete(c.id)} className="text-slate-900 hover:text-red-500 hover:bg-red-50 p-2.5 rounded-xl transition-colors">
 <Trash2 size={ 20 } />
 </button>
 <button onClick={() => setExpandedClass(isExpanded ? null : c.id)} className={`text-slate-900 hover:text-slate-900 hover:bg-slate-50 p-2.5 rounded-xl transition-colors ${ isExpanded ?'bg-slate-50 text-slate-900':''}`}>
 ...
 <h4 className="font-medium text-sm text-slate-900 uppercase tracking-widest">Subjects</h4>
 <button
 ...
 <p className="text-sm text-slate-900 font-medium text-center py-8 bg-white rounded-2xl border border-dashed border-gray-200">No subjects added yet.</p>
 ) : (
 ...
 <p className="text-slate-900 font-medium mt-1">Add one to get started.</p>
 </div>
 )}
 </div>
 ...
 className="bg-white backdrop-blur-xl rounded-2xl p-4 w-full max-w-md shadow-2xl border border-slate-300 relative overflow-hidden"
 >
 
 <div className="flex justify-between items-center mb-8 relative z-10">
 <h3 className="text-lg font-medium text-slate-900">Add New Class</h3>
 <button onClick={() => setShowAddClass(false)} className="p-2 text-slate-900 hover:text-slate-900 hover:bg-gray-100/50 rounded-full transition-colors">
 <X size={ 20 } />
 </button>
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-slate-900 mb-2">Class Name</label>
 <input
 type="text"
 required
 value={ newClassName }
 ...
 <div className="flex justify-between items-center mb-8 relative z-10">
 <h3 className="text-lg font-medium text-slate-900">Edit Class</h3>
 <button onClick={() => setClassToEdit(null)} className="p-2 text-slate-900 hover:text-slate-900 hover:bg-gray-100/50 rounded-full transition-colors">
 <X size={ 20 } />
 </button>
 </div>
 ...
 animate={{ scale: 1, opacity: 1, y: 0 }}
 exit={{ scale: 0.95, opacity: 0, y: 20 }}
 className="bg-white backdrop-blur-xl rounded-2xl p-4 w-full max-w-md shadow-2xl border border-slate-300 max-h-[90vh] overflow-y-auto relative"
 >
 
 <div className="flex justify-between items-center mb-8 relative z-10">
 <h3 className="text-lg font-medium text-slate-900">Add Subject</h3>
 <button onClick={() => {
 setShowAddSubject(null);
 setSelectedPredefinedSubjects([]);
 setNewSubjectName('');
 }} className="p-2 text-slate-900 hover:text-slate-900 hover:bg-gray-100/50 rounded-full transition-colors">
 <X size={ 20 } />
 </button>
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-slate-900 mb-2">Custom Subject Name (Optional)</label>
 <input
 type="text"
 ...
 <div>
 <label className="block text-sm font-medium text-slate-900 mb-2">Assign Teacher (Optional)</label>
 <select
 ...
 >
 <div className="flex justify-between items-center mb-8 relative z-10">
 <h3 className="text-lg font-medium text-slate-900">Edit Subject</h3>
 <button onClick={() => setSubjectToEdit(null)} className="p-2 text-slate-900 hover:text-slate-900 hover:bg-gray-100/50 rounded-full transition-colors">
 <X size={ 20 } />
 </button>
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-slate-900 mb-2">Subject Name</label>
 <input
 type="text"
 required
 ...
 <div>
 <label className="block text-sm font-medium text-slate-900 mb-2">Assign Teacher</label>
 <select
 ...
 <h3 className="text-lg font-medium mb-2 text-slate-900">Delete Class</h3>
 <p className="text-slate-900 font-medium mb-8">Are you sure you want to delete this class? This will not delete its subjects.</p>
 <div className="flex gap-4">
 <button onClick={() => setClassToDelete(null)} className="flex-1 py-2.5 rounded-full border border-gray-200/50 font-medium text-slate-900 hover:bg-slate-50 hover:text-slate-900 transition-colors bg-white">Cancel</button>
 ...
 <h3 className="text-lg font-medium mb-2 text-slate-900">Delete Subject</h3>
 <p className="text-slate-900 font-medium mb-8">Are you sure you want to delete this subject?</p>
 <div className="flex gap-4">
 <button onClick={() => setSubjectToDelete(null)} className="flex-1 py-2.5 rounded-full border border-gray-200/50 font-medium text-slate-900 hover:bg-slate-50 hover:text-slate-900 transition-colors bg-white">Cancel</button>

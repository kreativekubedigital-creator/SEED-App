...
export const SchoolAdminDashboard = ({ user, onLogout }: { user: UserProfile, onLogout: () => void }) => {
 ...
 <div className="w-24 h-24 bg-white rounded-3xl flex items-center justify-center text-blue-600 shadow-xl border border-slate-200">
 ...
 <div className="bg-white p-10 rounded-[2rem] text-center shadow-2xl max-w-md w-full border border-slate-200">

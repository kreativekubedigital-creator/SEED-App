...
import { db, collection, getDocs, query, where, addDoc, updateDoc, doc, onSnapshot, deleteDoc, OperationType, handleFirestoreError } from'../../lib/compatibility';
import { UserProfile, Session, Term, GradeScale } from'../../types';
